...
#Ahora buscamos la puntuacion maxima y su indice
puntuacionMaxima = max(puntuaciones)
indicePalabra = puntuaciones.index((max(puntuaciones)))
palabraMaxima = palabras[indicePalabra]
#Entregamos la salida
print('La palabra maxima y su puntacion respectiva es:')
print(palabraMaxima,'con',puntuacionMaxima,'puntos')
